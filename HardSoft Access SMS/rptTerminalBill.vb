...
Public Class rptTerminalBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_Access_SMS.rptTerminalBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTerminalBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTerminalBill = New rptTerminalBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
