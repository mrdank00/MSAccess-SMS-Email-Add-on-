...
Public Class rptTerminalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_Access_SMS.rptTerminalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTerminalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTerminalReport = New rptTerminalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
